    ...
    def _load_default_patterns(self):
        ...
        default_patterns = {
            ...
            r"(?i)^(what is your name|who are you|what should I call you)": [
                "I'm JARVIS, your AI assistant. I'm here to help with various tasks.",
                "You can call me JARVIS. I'm an advanced AI assistant.",
                "My name is JARVIS, and I'm designed to assist you with intelligent automation."
            ],
            ...
            # JARVIS specific
            r"(?i)^(are you jarvis|like jarvis|iron man)": [
                "Yes, I'm inspired by JARVIS from Iron Man! I aim to provide intelligent assistance.",
                "I share capabilities with JARVIS - voice recognition, data analysis, and intelligent responses.",
                "Like the famous JARVIS, I'm here to be your intelligent AI assistant!"
            ],
