...
def main():
    ...
    with tab1:
        ...
        activity_data = [
            ...
            {"timestamp": datetime.now() - timedelta(minutes=10), "component": "JARVIS", "action": "Voice command processed", "status": "success"},
    ...
    with tab5:
        ...
        with col2:
            ...
            sample_logs = [
                ...
                {"timestamp": datetime.now() - timedelta(minutes=2), "level": "INFO", "message": "JARVIS assistant ready"},
